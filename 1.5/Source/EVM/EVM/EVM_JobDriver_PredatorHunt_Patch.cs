...
namespace EVM
{
    ...
    internal class EVM_JobDriver_PredatorHunt_Patch
    {
        ...
        static IEnumerable<Toil> SwallowWholeIfYouShould(IEnumerable<Toil> toils, JobDriver_PredatorHunt __instance, bool __state, bool ___firstHit, bool ___notifiedPlayerAttacked)
        {
